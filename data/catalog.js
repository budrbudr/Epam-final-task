window.catalog = [{
    ...
    preview: ['img/monki-festval-knitted.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    preview: ['img/boyfriend-tshirt-bohemian.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: [],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/boyfriend-tshirt-paris.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 18'],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/repair-patches.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 18'],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/levis-jeans-women.png'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: [],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/crotchet.jpg'] // replace with paths to images extracted from item layout
    ...
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/dark-classic-suit-1.jpg', 'img/dark-classic-suit-2.jpg', 'img/dark-classic-suit-3.jpg'] // replace with paths to images extracted from item layout
    ...
    sizes: ['UK 19'],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/neck-knitted-jumper.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 17'],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/only-skinny-jeans.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: [],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/turtle-neck-jumper.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 19'],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/only-busted-knee-jean.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: [],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/colour-block.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 18', 'UK 19'],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/oversized-cardigan.jpg'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 18'],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/paul-joe-sister-jumper.jpg'] // replace with paths to images extracted from item layout
}];
